-- refresh materialized view app.mooring with data;

drop materialized view if exists app.mooring;
create materialized view app.mooring as
select
    reg.area_id,
    loc.location_id,
